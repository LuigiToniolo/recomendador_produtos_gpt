...
# ***********************************************
# Desafio de E-mails de recomendação de produtos
# ***********************************************

# 1. Identificar perfis a partir de uma lista de compras recentes por clientes
# 2. Para cada cliente:
#     2.1 Recomendar 3 produtos para o perfila partir de uma lista de produtos
...
"""
  ...
  conteudo = resposta.choices[0].message.content
  print("3. Finalizando a recomendação de produtos")
  return conteudo
    

def escreve_email(recomendacoes):
  print("4. Escrevendo e-mail de recomendação")
  prompt_sistema = f"""
  ...
  A empresa chama Americanas e o nome do responsável é Luigi Toniolo
  """
  ...
  conteudo = resposta.choices[0].message.content
  print("5. Finalizando escrita do e-mail")
  return conteudo
